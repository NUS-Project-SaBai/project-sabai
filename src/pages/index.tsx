        ...
        <div className="rounded-2xl bg-white p-8 sm:p-12 shadow-sm ring-1 ring-slate-900/5">
          <div className="max-w-2xl">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-600">
              ...
              Start managing your patient data with our powerful biometrics app.
            </p>
          ...
          <div className="mt-16 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              },
              {
                ...
                href: "/settings/village_codes",
              },
              {
                title: "Medication active ingredients",
                desc: "View placeholder frontend of active ingredients",
                href: "/medication/active-ingredients",
              },
              {
                title: "Medication brands",
                desc: "View placeholder frontend of brands",
                href: "/medication/brands",
              },
              {
                title: "Medication stock",
                desc: "View placeholder frontend of stock",
