...
export default function Login() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center">
      {/* Full-screen background image of Cambodia */}
      <Image
            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  className="block w-full rounded-lg border-0 px-3 py-2.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-200 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-slate-900 sm:text-sm transition-all duration-200"
