CREATE TABLE "eyesight" (
	...
	"comments" text,
	CONSTRAINT "eyesight_visit_id_unique" UNIQUE("visit_id")
);
...
--> statement-breakpoint
ALTER TABLE "eyesight" ADD CONSTRAINT "eyesight_visit_id_visits_id_fk" FOREIGN KEY ("visit_id") REFERENCES "public"."visits"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
