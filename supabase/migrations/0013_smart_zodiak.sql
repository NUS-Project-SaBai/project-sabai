...
ALTER TABLE "medication_stock" ALTER COLUMN "expiry" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "medication_stock" ALTER COLUMN "location" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "medication_stock" ALTER COLUMN "stock_status" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "medication_active_ingredients" ADD COLUMN "remarks" text;--> statement-breakpoint
ALTER TABLE "medication_brands" ADD COLUMN "remarks" text;--> statement-breakpoint
ALTER TABLE "medication_stock" ADD COLUMN "remarks" text;